...
public class ExistsLabelsClassifier implements Classifier {
    ...
    public static Classifier create(
        ...
        final ExistsLabelsClassifier d = new ExistsLabelsClassifier();
    ...
    private static final float THRESH_HOLD = 0.5F;
    ...
    private ExistsLabelsClassifier() {
    }
    ...
    private static List<Recognition> getResults(Map<String, Float> labelProb)
    {
        ...
        for (Map.Entry<String, Float> entry : labelProb.entrySet()) {
            recognitions.add(new Recognition("" + entry.getKey(), entry.getKey(), entry.getValue(), null));
        }
        return recognitions;
    }
}