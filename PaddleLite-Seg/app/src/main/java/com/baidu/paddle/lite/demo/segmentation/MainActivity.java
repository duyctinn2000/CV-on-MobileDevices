...
public class MainActivity extends AppCompatActivity {
    ...
    protected Button galleryButton,playButton,cameraButton;
...
//                        pbRunModel.dismiss();
        ...
        playButton=findViewById(R.id.detectButton);
...
//                runModel();
    ...
    public void onRunModelSuccessed() {
        ...
        tvInferenceTime.setText("Inference time: " + predictor.inferenceTime()/1000f + " s");
