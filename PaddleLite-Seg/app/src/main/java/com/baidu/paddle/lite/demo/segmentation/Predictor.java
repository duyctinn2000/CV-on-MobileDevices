...
public class Predictor {
    ...
    protected boolean loadModel(String modelPath, int cpuThreadNum, String cpuPowerMode) {
        ...
        config.setModelFromFile(realPath + File.separator + "myok.nb");
...
//        inferenceTime = (endInfer - startInfer) / 1000.0f;
    ...
    public boolean runModel(Preprocess preprocess, Visualize visualize) {
        ...
        long startInfer = SystemClock.uptimeMillis();
...
//        inferenceTime = (end.getTime() - start.getTime()) / (float) inferIterNum;
        ...
        Log.i("pre",""+preprocessTime);
        Log.i("infer",""+(inferenceTime-preprocessTime-postprocessTime));
        Log.i("post",""+postprocessTime);
